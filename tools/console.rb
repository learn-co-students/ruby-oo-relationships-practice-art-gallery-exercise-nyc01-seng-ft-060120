...
artist1 = Artist.new("george bush", 3, [donor1, donor2])
artist2 = Artist.new("tom", 1, [donor3])
artist3 = Artist.new("beth", 2, [donor1])
artist4 = Artist.new("davinci", 30, [donor3, donor2])
artist5 = Artist.new("apple paltrow", 4, [donor2, donor3])
artist6 = Artist.new("elon musk", 10, [donor2, donor1])
